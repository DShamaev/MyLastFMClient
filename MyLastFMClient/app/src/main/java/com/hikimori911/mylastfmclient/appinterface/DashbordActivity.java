...
public class DashbordActivity extends Activity
        implements MainMenuFragment.NavigationDrawerCallbacks {

    /**
     * Fragment managing the behaviors, interactions and presentation of the navigation drawer.
     */
    private MainMenuFragment mNavigationDrawerFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNavigationDrawerFragment = (MainMenuFragment)
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Activity activity) {
            ...
            ((DashbordActivity) activity).onSectionAttached(
